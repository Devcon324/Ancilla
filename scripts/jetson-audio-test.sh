...
#
# Usage:
#   bash scripts/jetson-audio-test.sh
#   bash scripts/jetson-audio-test.sh --no-playback   # detect only, no sound/record
#   bash scripts/jetson-audio-test.sh --connect         # run bt-soundblade first
#
# Env overrides:
