...
WAKE_WORD_THRESHOLD = float(_env("WAKE_WORD_THRESHOLD", "0.65"))
WAKE_WORD_CONSECUTIVE_HITS = int(_env("WAKE_WORD_CONSECUTIVE_HITS", "2"))
WAKE_WORD_INTERRUPT_THRESHOLD = float(_env("WAKE_WORD_INTERRUPT_THRESHOLD", "0.85"))
WAKE_WORD_INTERRUPT_GRACE_SECONDS = float(_env("WAKE_WORD_INTERRUPT_GRACE_SECONDS", "1.0"))
WAKE_WORD_POST_SPEECH_COOLDOWN_SECONDS = float(
    _env("WAKE_WORD_POST_SPEECH_COOLDOWN_SECONDS", "0.8")
)
...
SILENCE_TIMEOUT_SECONDS = float(_env("SILENCE_TIMEOUT_SECONDS", "0.45"))
NO_SPEECH_TIMEOUT_SECONDS = float(_env("NO_SPEECH_TIMEOUT_SECONDS", "2.0"))
