...
1. Start whisper + llama servers (or use `scripts/jetson-run.sh`).
...
- [Bluetooth speaker troubleshooting & permanent SSH setup](jetson-bluetooth-speaker-ssh.md) (PipeWire env, GDM conflict, `.bashrc`, `bt-soundblade`)
- [Connect a microphone over SSH](jetson-microphones-ssh.md)
