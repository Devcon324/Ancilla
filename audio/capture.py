...
from config import SAMPLE_RATE, MIC_DEVICE

_vad_model = None

MAX_RECORD_SECONDS = 12
SILENCE_TIMEOUT_SECONDS = 1.2
# Ensure your input stream block size is explicitly set to 512 or 1024
CHUNK_SIZE = 512  # or 1024
SAMPLE_RATE = 16000

def record_utterance() -> np.ndarray:
  """Records mic audio until ~1.2s of silence follows speech. Returns int16 PCM."""
  global _vad_model
